...
// TestDashboard_RenderSessionInfo removed - renderSessionInfo() method no longer exists (unused legacy code)
// TestDashboard_GetTaskStats removed - getTaskStats() method no longer exists (unused legacy code)
// TestDashboard_RenderProgressIndicator removed - renderProgressIndicator() method no longer exists (unused legacy code)
